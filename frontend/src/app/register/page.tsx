...
import { register, getOAuthProviders, getGoogleOAuthUrl, getAppleOAuthUrl, type OAuthProviders } from "../../lib/api";
  ...
  return (
    <main className={containerClass}>
      <div className={cardClass}>
        ...
        {oauthProviders && (oauthProviders.google || oauthProviders.apple) && (
          <>
